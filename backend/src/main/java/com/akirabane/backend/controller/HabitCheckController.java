...
import com.akirabane.backend.dto.HabitCheckRequestDto;
...
public class HabitCheckController {
    ...
    public HabitCheckModel toggleCheck(@PathVariable Long habitId,
                                       @RequestBody HabitCheckRequestDto request) {
    ...
    public List<HabitCheckModel> getChecksInRange(
    ...
    public HabitStatsResponseDto getStats(
            @PathVariable Long habitId,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate start,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate end) {
